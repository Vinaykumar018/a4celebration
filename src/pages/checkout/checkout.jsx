              ...
              <div className="sticky top-4 space-y-6">
                      ...
                      <div key={item._id} className="p-4 border-b border-rose-100 hover:bg-rose-50 transition-colors">
                        <div className="flex gap-3">
                          ...
                          <div className="flex-1 space-y-1">
                            <h3 className="font-medium text-rose-800">{item.product_name}</h3>
                            ...
                            <div className="flex items-center gap-1 text-xs text-gray-600">
                              ...
                              <span>Date: {new Date(item.pooja_date).toLocaleDateString()}</span>
                            </div>
                            <div className="flex items-center gap-1 text-xs text-gray-600">
                              <Clock className="h-3 w-3 text-rose-500" />
                              <span>Time: {item.pooja_time}</span>
                            </div>
                ...
                <div className="bg-gradient-to-r from-rose-50 to-pink-50 border-2 border-rose-200 rounded-xl p-4 text-sm shadow-sm">
                  ...
                  <p className="text-gray-700 mb-2">
                    Our team will contact you within 24 hours to finalize your celebration details and confirm the auspicious timings.
                  </p>
