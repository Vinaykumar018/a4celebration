...
const ChildCategoryFilter = () => {
  ...
  return (
    <div className="py-5 mb-8">
      <h3 className="text-lg font-semibold px-4 mb-4 text-gray-800">Event Management Categories</h3>

      <div className="relative">
        <div className="flex space-x-6 px-4 pb-2 overflow-x-auto scrollbar-hide p-2">
